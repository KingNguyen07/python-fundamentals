...
# elif example
# Used when the first condition is false 'and you want to print another
...
# The inner if statement only evaluates if the outer is true.
happy = 14
...
# Ternary Statement
# One condition can be preformed on one line
